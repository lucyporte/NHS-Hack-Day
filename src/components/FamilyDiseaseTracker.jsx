...
const FamilyDiseaseTracker = () => {
  ...
  const getRelationshipDegree = (relationship) => {
    const firstDegree = ['parent', 'sibling', 'child', 'father', 'mother', 'sister', 'brother'];
    const secondDegree = ['grandparent', 'aunt', 'aunty', 'uncle', 'niece', 'nephew', 'grandchild', 'grandmother', 'grandfather', 'grandson', 'granddaughter'];
